...
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {email: a, password: b, history: c, mdl: d, spin: e, page: f};
	});
var _user$project$Model$BadgePage = {ctor: 'BadgePage'};
var _user$project$Model$GamePage = {ctor: 'GamePage'};
var _user$project$Model$LoginPage = {ctor: 'LoginPage'};
var _user$project$Model$Noop = {ctor: 'Noop'};
var _user$project$Model$ChangePage = function (a) {
	return {ctor: 'ChangePage', _0: a};
};
var _user$project$Model$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Model$UpdatePassword = function (a) {
...
var _user$project$HtmlComponents$passwordfield = F4(
	function (model, defVal, msg, label) {
		return A5(
			_debois$elm_mdl$Material_Textfield$render,
			_user$project$Model$Mdl,
			{
				ctor: '::',
				_0: _Skinney$fnv$FNV$hashString(label),
				_1: {ctor: '[]'}
			},
			model.mdl,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Textfield$value(defVal),
						_1: {
							ctor: '::',
...
var _user$project$HtmlComponents$textfield = F4(
	function (model, defVal, msg, label) {
		return A5(
			_debois$elm_mdl$Material_Textfield$render,
			_user$project$Model$Mdl,
...
var _user$project$HtmlComponents$logo = function (sizepx) {
	return A2(
		_elm_lang$html$Html$img,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src('img/logo.svg'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'max-width', _1: sizepx},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$HtmlComponents$loginPage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'margin', _1: '0px auto'},
					_1: {
						ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$HtmlComponents$logo('300px'),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'border-top', _1: '1rem solid #eee'},
										_1: {ctor: '[]'}
									}
								}
							}),
					...
					{
						ctor: '::',
						_0: A4(_user$project$HtmlComponents$textfield, model, model.email, _user$project$Model$UpdateEmail, 'Email'),
						_1: {
							ctor: '::',
							_0: A4(_user$project$HtmlComponents$passwordfield, model, model.password, _user$project$Model$UpdatePassword, 'Password'),
							_1: {
								ctor: '::',
								_0: A5(
									...
									{
										ctor: '::',
										_0: _Skinney$fnv$FNV$hashString('#games'),
										_1: {ctor: '[]'}
									},
									model.mdl,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Button$link('#games'),
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Model$Noop),
													_1: {ctor: '[]'}
												}
											}
										}
								...
								_1: {
									...
									_0: _debois$elm_mdl$Material_Spinner$spinner(
										{
											ctor: '::',
											_0: _debois$elm_mdl$Material_Spinner$active(model.spin),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$HtmlComponents$viewBody = function (model) {
	var page = function () {
		var _p0 = model.page;
		if (_p0.ctor === 'LoginPage') {
			return _user$project$HtmlComponents$loginPage(model);
		} else {
			return _elm_lang$html$Html$text('page coming soon');
		}
	}();
	return A2(
		_elm_lang$html$Html$div,
...
var _user$project$HtmlComponents$header = function (title) {
	return A2(
...
var _user$project$HtmlComponents$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
var _user$project$HtmlComponents$rootView = function (model) {
	return A4(
		...
		{ctor: '[]'},
		{
			...
			main: {
				ctor: '::',
				_0: _user$project$HtmlComponents$viewBody(model),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$Update$page = function (hash) {
	var _p0 = hash;
	switch (_p0) {
		case '#games':
			return _user$project$Model$GamePage;
		case '#badges':
			return _user$project$Model$BadgePage;
		default:
			return _user$project$Model$LoginPage;
	}
};
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'ChangePage':
				var _p2 = _p1._0;
				var newPage = _user$project$Update$page(_p2.hash);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$View$view = function (model) {
	return _user$project$HtmlComponents$rootView(model);
};

var _user$project$Main$model = function (location) {
	return {
		email: '',
		password: '',
		history: {
		...
		spin: false,
		page: _user$project$Model$LoginPage
	};
};
var _user$project$Main$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Main$model(location),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Model$ChangePage,
	{
